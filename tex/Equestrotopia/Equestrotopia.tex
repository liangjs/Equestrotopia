...
\title{Progressive Photon Mapping\\ \large ---计算机图形学大作业报告}
\author{吴克文\ 梁家硕}
\date{2017年5月}
\begin{document}
\maketitle
...
\section{环境}
Arch Linux x86\_64 Linux 4.10.13-1-ARCH\par
gcc (GCC) 6.3.1 20170306\par
cmake version 3.8.0\par
GNU Make 4.2.1\par
OpenGL version: 3.0 Mesa 17.0.5\par
\section{运行}
\begin{minted}{shell}
     $ cmake .
     $ make 
...
删去了繁琐的细节调整和性能优化部分。\\
注：\par
BRDF参数及读取代码来自网站\url{http://www.merl.com/brdf/}。\\
\begin{algorithm}[H]
...
还可以加上射线方向性的剪枝。考虑$\mathbf{c}$在分界面左侧，且%
